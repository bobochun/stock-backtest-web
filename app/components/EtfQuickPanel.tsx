    ...
    <section className="rounded-3xl bg-white p-6 shadow-sm">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-500">
          這裡是主要功能按鈕。找不到參數最佳化時，直接按這裡的紫色按鈕。
        </p>
      </div>
      ...
      <div className="mt-5 grid gap-3 md:grid-cols-4">
        ...
        <button
          ...
          className="rounded-2xl bg-purple-600 px-5 py-4 text-sm font-bold text-white shadow-sm disabled:cursor-not-allowed disabled:opacity-60"
        >
